...
ALBSource='s3://<bucket>/<prefix>/AWSLogs/' #S3 bucket path where logs are stored (including any custom prefix) with NO SPACES (must end with /AWSLogs/) and be located in the region specified in ParamALBRegion
